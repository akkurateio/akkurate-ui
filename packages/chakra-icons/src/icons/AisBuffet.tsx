...
export const AisBuffet = createIcon({
  displayName: "AisBuffet",
  viewBox: "0 0 32 32",
  defaultProps: {
    fill: "currentColor",
    boxSize: "24px",
  ...
  path: (
    <>
      ...
      />
      <path d="M23 6a1 1 0 0 0-1 1v2a1 1 0 1 0 2 0V7a1 1 0 0 0-1-1ZM26 5a1 1 0 1 1 2 0v4a1 1 0 1 1-2 0V5Z" />
    </>
  ),
})
