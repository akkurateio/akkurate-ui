...
export const AisElevatorUp = createIcon({
  displayName: "AisElevatorUp",
  viewBox: "0 0 32 32",
  defaultProps: {
    fill: "currentColor",
    boxSize: "24px",
  ...
  path: (
    <>
      ...
      />
      <path d="M27 22.414V23a1 1 0 1 0 2 0v-3a1 1 0 0 0-1-1h-3a1 1 0 1 0 0 2h.586l-4.293 4.293a1 1 0 0 0 1.414 1.414L27 22.414Z" />
    </>
  ),
})
