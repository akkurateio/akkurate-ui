...
export const AisFirewall = createIcon({
  displayName: "AisFirewall",
  viewBox: "0 0 32 32",
  defaultProps: {
    fill: "currentColor",
    boxSize: "24px",
  ...
  path: (
    <>
      ...
      />
      <path d="M28 22.397v-3c1.875 1.429 3 3 3 5A5 5 0 0 1 27.954 29 7.528 7.528 0 0 0 26 25.397 7.528 7.528 0 0 0 24.046 29 5.001 5.001 0 0 1 21 24.397c0-2 1-4 5-9v3c0 2.5 1 4 2 4Z" />
    </>
  ),
})
