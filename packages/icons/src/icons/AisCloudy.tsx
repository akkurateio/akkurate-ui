...
export const AisCloudy: FunctionComponent<IProps> = ({
  size = IconSize.md,
  className = "",
}) => {
  return (
    ...
    >
      <path d="M17 3.005a1 1 0 1 1 2 0v2a1 1 0 1 1-2 0v-2ZM23.657 6.934a1 1 0 0 0 1.414 1.414l1.414-1.414a1 1 0 1 0-1.414-1.414l-1.414 1.414Z" />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
      ...
      />
      <path d="M26 14.005a1 1 0 0 1 1-1h2a1 1 0 1 1 0 2h-2a1 1 0 0 1-1-1ZM9.515 5.52a1 1 0 0 0 0 1.414l1.414 1.414a1 1 0 1 0 1.415-1.414L10.928 5.52a1 1 0 0 0-1.414 0Z" />
    </svg>
  )
}
