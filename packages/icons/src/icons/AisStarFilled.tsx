...
export const AisStarFilled: FunctionComponent<IProps> = ({
  size = IconSize.md,
  className = "",
}) => {
  return (
    ...
    >
      <path d="M16 23.9 8.584 28 10 19.317l-6-6.15 8.292-1.267L16 4l3.708 7.9L28 13.167l-6 6.15L23.416 28 16 23.9Z" />
