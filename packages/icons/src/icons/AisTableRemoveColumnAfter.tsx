...
export const AisTableRemoveColumnAfter = createIcon({
  displayName: "AisTableRemoveColumnAfter",
  viewBox: "0 0 32 32",
  defaultProps: {
		fill: "currentColor",
    boxSize: "24px",
