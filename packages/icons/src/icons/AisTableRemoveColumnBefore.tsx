...
export const AisTableRemoveColumnBefore = createIcon({
  displayName: "AisTableRemoveColumnBefore",
  viewBox: "0 0 32 32",
  defaultProps: {
		fill: "currentColor",
    boxSize: "24px",
