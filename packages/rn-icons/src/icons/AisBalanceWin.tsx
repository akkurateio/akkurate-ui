...
export const AisBalanceWin: FunctionComponent<IIconProps> = createIcon({
  viewBox: "0 0 32 32",
  path: [
    <ReactSVG.G key={1}>
      <ReactSVG.Path
      ...
      <ReactSVG.Path d="M27.72 20.928c.582.957.24 2.202-.866 2.553a11.079 11.079 0 0 1-6.708 0c-1.105-.351-1.448-1.596-.866-2.553L23.5 14l4.22 6.928Z" />
      <ReactSVG.Path
