...
export const AisCalculator: FunctionComponent<IIconProps> = createIcon({
  ...
  path: [
    <>
      <ReactSVG.Path d="M24 2H8C6.346 2 5 3.346 5 5v22c0 1.654 1.346 3 3 3h16c1.654 0 3-1.346 3-3V5c0-1.654-1.346-3-3-3Zm1 25c0 .551-.449 1-1 1H8c-.551 0-1-.449-1-1V5c0-.551.449-1 1-1h16c.551 0 1 .449 1 1v22Z" />
