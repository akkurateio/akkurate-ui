...
export const AisClassRoom: FunctionComponent<IIconProps> = createIcon({
  viewBox: "0 0 32 32",
  path: [
    <ReactSVG.G key={1}>
      <ReactSVG.Path
      ...
      />
      <ReactSVG.Path d="M15 4a1 1 0 1 0 0 2h13v15H15a1 1 0 1 0 0 2h14a1 1 0 0 0 1-1V5a1 1 0 0 0-1-1H15Z" />
    </ReactSVG.G>,
  ],
})
