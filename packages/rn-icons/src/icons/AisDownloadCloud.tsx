...
export const AisDownloadCloud: FunctionComponent<IIconProps> = createIcon({
  viewBox: "0 0 32 32",
  path: [
    <ReactSVG.G key={1}>
      ...
      <ReactSVG.Path d="M19.293 24.293 17 26.586V13a1 1 0 1 0-2 0v13.586l-2.293-2.293a.999.999 0 1 0-1.414 1.414l3.999 3.999a.99.99 0 0 0 .326.217.991.991 0 0 0 1.09-.217l3.999-3.999a.999.999 0 1 0-1.414-1.414Z" />
    </ReactSVG.G>,
  ],
})
