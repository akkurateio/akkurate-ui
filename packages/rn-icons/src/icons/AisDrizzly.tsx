...
export const AisDrizzly: FunctionComponent<IIconProps> = createIcon({
  viewBox: "0 0 32 32",
  path: [
    <ReactSVG.G key={1}>
      <ReactSVG.Path
      ...
      />
      <ReactSVG.Path d="M10.513 29.873a1 1 0 0 0 1.381-.426l2-4a1 1 0 1 0-1.788-.894l-2 4a1 1 0 0 0 .407 1.32Z" />
    </ReactSVG.G>,
  ],
})
