...
export const AisLocation: FunctionComponent<IIconProps> = createIcon({
  ...
  path: [
    <ReactSVG.G key={1}>
      <ReactSVG.Path d="M16 10.515A3.488 3.488 0 0 0 12.515 14 3.488 3.488 0 0 0 16 17.485 3.488 3.488 0 0 0 19.485 14 3.488 3.488 0 0 0 16 10.515Zm0 4.971a1.487 1.487 0 0 1-1.485-1.485c0-.818.666-1.485 1.485-1.485.819 0 1.485.667 1.485 1.485 0 .818-.666 1.485-1.485 1.485Z" />
