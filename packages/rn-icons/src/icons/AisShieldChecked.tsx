...
export const AisShieldChecked: FunctionComponent<IIconProps> = createIcon({
  viewBox: "0 0 32 32",
  path: [
    <ReactSVG.G key={1}>
      ...
      <ReactSVG.Path d="M12.707 13.293a.999.999 0 1 0-1.414 1.414l3 3a.997.997 0 0 0 1.414 0l5-5a.999.999 0 1 0-1.414-1.414L15 15.586l-2.293-2.293Z" />
    </ReactSVG.G>,
  ],
})
