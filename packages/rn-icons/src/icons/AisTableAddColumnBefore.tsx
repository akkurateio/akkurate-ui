...
const AisTableAddColumnBefore = (props: SvgProps) => (
  <Svg fill="none" viewBox="0 0 32 32" {...props}>
    <Path
      fill="#000"
      d="M3.707 2.293a1 1 0 0 0-1.414 1.414l3 3a1 1 0 0 0 1.414 0l3-3a1 1 0 0 0-1.414-1.414L6 4.586 3.707 2.293Z"
    />
    <Path
      fill="#000"
      fillRule="evenodd"
