...
export const AisTableAddColumnBefore: FunctionComponent<IIconProps> =
  createIcon({
    viewBox: "0 0 32 32",
    path: [
      <>
        <ReactSVG.Path d="M3.707 2.293a1 1 0 0 0-1.414 1.414l3 3a1 1 0 0 0 1.414 0l3-3a1 1 0 0 0-1.414-1.414L6 4.586 3.707 2.293Z" />
        <ReactSVG.Path
          fillRule="evenodd"
          clipRule="evenodd"
