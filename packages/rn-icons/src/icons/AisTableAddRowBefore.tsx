...
export const AisTableAddRowBefore: FunctionComponent<IIconProps> = createIcon({
  ...
  path: [
    <>
      <ReactSVG.Path d="M2.293 8.293a1 1 0 0 0 1.414 1.414l3-3a1 1 0 0 0 0-1.414l-3-3a1 1 0 0 0-1.414 1.414L4.586 6 2.293 8.293ZM13 5a1 1 0 1 0 0-2 1 1 0 0 0 0 2Z" />
      <ReactSVG.Path
        fillRule="evenodd"
        clipRule="evenodd"
