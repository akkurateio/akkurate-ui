...
export const AisUploadCloud: FunctionComponent<IIconProps> = createIcon({
  ...
  path: [
    <ReactSVG.G key={1}>
      ...
      <ReactSVG.Path d="M19.293 17.707a.997.997 0 0 0 1.414 0 .999.999 0 0 0 0-1.414l-3.999-3.999a1.001 1.001 0 0 0-1.416 0l-3.999 3.999a.999.999 0 1 0 1.414 1.414L15 15.414V29a1 1 0 1 0 2 0V15.414l2.293 2.293Z" />
    </ReactSVG.G>,
  ],
})
