...
export const AisWatchAlternative: FunctionComponent<IIconProps> = createIcon({
  viewBox: "0 0 32 32",
  path: [
    <ReactSVG.G key={1}>
      <ReactSVG.Path d="M16 10a1 1 0 0 1 1 1v4.586l1.707 1.707a1 1 0 0 1-1.414 1.414L15.586 17A2 2 0 0 1 15 15.586V11a1 1 0 0 1 1-1Z" />
      <ReactSVG.Path
        fillRule="evenodd"
        clipRule="evenodd"
